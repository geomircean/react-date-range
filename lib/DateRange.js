...
var DateRange = (function (_Component) {
  ...
  _createClass(DateRange, [{
    ...
    key: 'setRange',
    value: function setRange(range, silent) {
    ...
    value: function componentWillReceiveProps(newProps) {
      ...
      if (newProps.startDate !== this.props.startDate && newProps.startDate === '' || newProps.endDate !== this.props.endDate && newProps.endDate === '') {
        var format = newProps.format || this.props.format;
        this.setRange({
          startDate: _moment2['default'](),
          endDate: _moment2['default']()
        }, true);
      }
