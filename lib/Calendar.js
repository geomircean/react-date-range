    ...
    value: function renderMonthAndYear() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          this.state.showMonthsView ? _react2['default'].createElement(_MonthsViewJs2['default'], { setMonth: this.setMonth.bind(this), shownDate: this.state.shownDate, appendTime: this.appendTime.bind(this) }) : '',
